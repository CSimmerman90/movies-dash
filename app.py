    ...
    html.Div([
        ...
        html.Div([
            dcc.RangeSlider(
                ...
                value=[1980, 1985], id='my-range-slider'
            ),
            dcc.Checklist(id= 'my-checklist', options=[{"value": i, "label": i} for i in df['genre'].unique()],
                     value= ['Action']),
        ]),
        dcc.Graph(
...
@app.callback(
    dash.dependencies.Output('cities-radio', 'value'),
    [dash.dependencies.Input('cities-radio', 'options')])
...
@app.callback(
    ...
    [dash.dependencies.Input('countries-radio', 'value')],
    [dash.dependencies.Input('cities-radio', 'value')])
